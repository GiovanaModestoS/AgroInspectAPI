...
O cliente cadastra a máquina (tipo, modelo e horas)
O sistema identifica a faixa de horas correspondente
Um checklist adequado é sugerido automaticamente
O operador realiza a inspeção
Fotos são solicitadas apenas em caso de falha
O histórico fica registrado por máquina
